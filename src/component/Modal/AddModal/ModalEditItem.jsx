...
import { openModalAdd, openModalEdit, openSuccessModal } from '../../../state/universalSlice'
import { useFormik } from 'formik'
import { modalAddSchema } from '../../../schemas'
import axios from 'axios'
import AlertModal from '../AlertModal/AlertModal'

const ModalEditItem = ({editData}) => {
                       ...
                       />
                        {
                         ...
                         {
                           uploadImage === '' ?
                           <p className="file-name">{editData[0].image || ''}</p>
                            :
                            ''
                         }
                   </div>
