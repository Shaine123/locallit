...
const ModalDetailsAdmin = ({data, orders}) => {
  ...
  return (
    <div className='modal-bg' style={{paddingTop: '50px', paddingLeft: '24vw'}}>
       <div className="modal-container-summary" >
        <div className="modal-title-summary">Order Summary</div>
           <button className="close-btn" onClick={() => { dispatch(openSummaryModal())}}>
            ...
            <div className="summary-box">
                ...
                <div className="summary-desc">
                    <p><span style={{color: '#878d5d'}}>User id:</span> {orders.userid}</p>
                    <p><span style={{color: '#878d5d'}}>User name:</span> {orders.userinfo.firstname} {orders.userinfo.lastname}</p>
                    <p><span style={{color: '#878d5d'}}>User phonenumber:</span> {orders.userinfo.phonenumber}</p>
                    <p><span style={{color: '#878d5d'}}>User address:</span> {orders.userinfo.address}</p>
